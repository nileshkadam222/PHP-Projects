  ...
  <div id="view">
        ...
        <div align="center">
		  <form name="f1" method="post" action="singup2.php" enctype="multipart/form-data">
              ...
              <tr>
                ...
                <td colspan="3" align="left"><input  name="t2" type="text"  style="background-color:#CCCCCC" size="50" maxlength="50" onkeypress="char_check(event)" /></td>
              </tr>
              <tr>
   ...
   ?>
              ...
              <tr>
                ...
                <td colspan="2"><input name="t4" type="text" style="background-color:#CCCCCC" size="30" maxlength="30"  onkeypress="char_check(event)" /></td>
              </tr>
              <tr>
                <td height="46" align="left"><span class="style5"><font size="+2">Contact No.</font></span></td>
                <td colspan="2"><input name="t5" type="text" style="background-color:#CCCCCC" size="30" maxlength="10" onkeypress="num_check(event)"/></td>
              </tr>
              <tr>
