...
//echo "Connect";
$q=mysql_query("select * from item_detail where description='Bollywood Sari'");
...
$no=0;
echo "<div id='image'>";
echo "<a href='bollywood.php'> <br>* Bollywood Saris ...</a>";
echo "</div>";
echo "<div id='pageno'><br><br>Page  : ";
$pages=$nro/4;
for($k=1; $k<$pages+1; $k++)
echo "         <a href='bollywood.php?id=$k'>$k</a>";
echo "</div>";
...
while($d=mysql_fetch_array($q))
{
	...
	if(!isSet($pg) || $pg==1)
		...
		echo "<input type='hidden' value='$pg' name='page'>";
