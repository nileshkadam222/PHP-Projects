...
$q=mysql_query("select * from item_detail where description='Traditional Sari'");
...
$no=0;
echo "<div id='image'>";
echo "<a href='traditional.php'> <br>* Traditional Saris ...</a>";
echo "</div>";

echo "<div id='pageno'><br><br>Page  : ";
$pages=$nro/4;
for($k=1; $k<$pages+1; $k++)
echo "         <a href='traditional.php?id=$k'>$k</a>";
echo "</div>";
