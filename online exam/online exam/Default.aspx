<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Default.aspx.cs" MasterPageFile="~/MasterPage3.master" Inherits="_Default" Theme="Silver" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:LoginView ID="LoginView1" runat="server">
            <AnonymousTemplate>
                <table width="560" align="center">
                    ...
                    <tr>
                        <td width="100%">
                            <asp:Login ID="Login1" runat="server" TitleText="" PasswordRecoveryText="Forgot your password?" PasswordRecoveryUrl="~/recoverpassword.aspx" BorderColor="Yellow" BorderStyle="Outset" BorderWidth="4px" Font-Bold="True" Font-Names="Arial" ForeColor="#FF8000" Height="164px" Width="321px">
                                ...
                                <LoginButtonStyle BackColor="Yellow" BorderColor="#00C000" BorderStyle="Outset" Font-Bold="True"
                                    Font-Names="Arial" Font-Size="Medium" ForeColor="#00C000" />
                            </asp:Login>
                        </td>
                    </tr> 
                    <tr>
                    ...
                    <tr>
                        <td width="100%">
                            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BorderColor="Yellow" BorderStyle="Outset" BorderWidth="4px" Font-Bold="True" Font-Names="Arial" ForeColor="#FF8000" Height="291px">
                                <WizardSteps>
                                ...
                                <SideBarButtonStyle BackColor="White" />
                                <StartNextButtonStyle BackColor="White" />
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Comic Sans MS"
        ForeColor="#FF8000" OnClick="LinkButton1_Click" Style="z-index: 100; left: 550px;
        position: absolute; top: 90px">HOME</asp:LinkButton>
    </asp:Content>