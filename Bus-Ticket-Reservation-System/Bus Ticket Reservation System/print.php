...
<tr><td><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody><tr> 
          ...
          <!-- lhs end -->
          <!-- mid str -->
          <td align="center" valign="top" width="580" style="height: 406px">
                    ...
                    <tr>
                      <td >
						<div class="style16">
							<span ><strong><span >
							<br>
							Confirm to Print Ticket</span><br>
						<br>
						</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="Submit1" type="submit" value="Print"  style="width: 99px">&nbsp;&nbsp;&nbsp;&nbsp;
<input name="Submit2" type="submit" value="Cancel"  style="width: 91px"><br>
<br>
						</div>
						</form>
						</strong></span> </td>
