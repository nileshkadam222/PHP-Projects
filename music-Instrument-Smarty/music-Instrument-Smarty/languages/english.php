...
define('STRING_GREETINGS', '<h1>Welcome to Music Store!</h1>
<p>Everything related to music sold here, all music equipments like drums, guitars, pianos, synthesizers.<br />
The complete music shopping store means Music Store.</p>');
