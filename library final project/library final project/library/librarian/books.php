			   ...
			   <div class="alert alert-info">
						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="my_wishlist.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;My Wish list</a></p>
                                ...
                                <tbody>
								  ...
								  $user_query=mysql_query("select * from book where status != 'Archive'")or die(mysql_error());
                                    ...
                                    <td class="action">
										...
										<a  rel="tooltip"  title="Wishlist" id="e<?php echo $id; ?>" href="edit_book.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
