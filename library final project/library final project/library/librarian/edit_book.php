...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		...
		?>
             <div class="alert alert-info"><i class="icon-pencil"></i>&nbsp;ADD WISHLIST</div>
			<p><a class="btn btn-info" href="books.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
	<div class="addstudent">
	<div class="details">ADD To Wishlist</div>	
	<form class="form-horizontal" method="POST" action="update_books.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			<div class="controls">
			<button name="submit" type="submit" class="btn btn-success"><i class="icon-save icon-large"></i>&nbsp;Add wish list</button>
			</div>
		</div>
    </form>				
			</div>		
