...
(11, 'Java Server Programming', '17', '''jsp uses  html tags and run on java platform''', 'BPB Prakashan', '2000', 'jsp123', 1800, 560, 'upload_image/1861004656.jpg', 'upload_ebook/Java_2_5th-www.netbks.com.pdf', 1),
(12, 'Programming with Perl', '17', 'Perl is programming langauge which is not comfortable to handle.', 'Wrox', '1995', 'perl123', 560, 450, 'upload_image/0596000278.jpg', 'upload_ebook/perl.docx', 1),
(13, 'HTML for world wide web', '19', 'html uses tags,it''''s  not case sensitive,work with own html tagswhich must be enclosed.', 'Elizabeth', '2005', 'htmlabc12', 560, 400, 'upload_image/0201354934.jpg', 'upload_ebook/html.pdf', 1),
(14, 'ASP Server Pages 3.0', '17', 'Active server pages uses xml files ,it run on internet explorer or other browser..', 'Microsoft', '1995', 'asp123', 1150, 950, 'upload_image/1861003382.jpg', 'upload_ebook/asp.doc', 1),
(15, 'Perl and CGI', '17', 'CGI for graphics purpose', 'Pearson', '1999', 'pc2343', 450, 300, 'upload_image/020135358X.gif', 'upload_ebook/perl1.pdf', 1),
(16, 'A Biological Survey for the Nation', '27', 'The National Biological Survey will produce the map we need to avoid the\\r\\neconomic and environmental "train wrecks" we see scattered across the country.\\r\\nNBS will provide the scientific knowledge America needs to balance the\\r\\ncompatible goals of ecosystem protection and economic progress', 'National Research Council', '1994', '0-309-5860', 224, 450, 'upload_image/biology.gif', 'upload_ebook/g.pdf', 1),
(17, 'Book of Tea', '23', 'The Philosophy of Tea is not mere aestheticism in the ordinary acceptance of the term, for it expresses conjointly with ethics and religion our whole point of view about man and nature. It is hygiene, for it enforces cleanliness.It represents the true spirit of Eastern democracy by making all its votaries aristocrats in taste. (from "The Book of Tea")', 'Kakuzo Okakura', '2008', 'tea1', 80, 100, 'upload_image/bookoftea.jpg', 'upload_ebook/tea.docx', 1),
...
(5, 'NILESH', 'nilesh.kadam222@gmail.com', 'ITS WORKK'),
(6, 'pooja', 'nilesh.kadam222@gmail.com', 'hiiiii its workkk');
...
INSERT INTO `notes` (`name`, `path`, `type`, `sem`, `size`, `user`) VALUES
('SUMMER INTERNSHIP REPORT CERTIFICATES.pd', 'upload_ebook/SUMMER INTERNSHIP REPORT CE', 'application/pdf', 1, '50143', 'nilesh123'),
('New Microsoft Office Word Document (2).d', 'upload_ebook/New Microsoft Office Word D', 'application/vnd.openxmlformats-officedoc', 1, '0', 'nilesh123');
...
INSERT INTO `problem` (`con_id`, `con_nm`, `user_id`, `con_email`, `con_query`) VALUES
(7, 'NILESH', '', 'nilesh.kadam222@gmail.com', 'hiiiiiiii'),
(8, 'NILESH', '5001', 'nilesh.kadam222@gmail.com', 'hiiiiiiiiiiiiiiiiiiiiiiiii\r\n');
...
INSERT INTO `return` (`returnid`, `bookid`, `userid`, `returndate`) VALUES
(2, 6, 5001, '2015-09-08'),
(3, 1, 5001, '2015-09-08');
...
INSERT INTO `user` (`u_id`, `roll_no`, `std`, `dob`, `u_fnm`, `u_unm`, `u_pwd`, `u_gender`, `u_email`, `u_contact`, `add`, `u_city`, `issue_date`, `valid_till`, `type`, `photo`) VALUES
(5001, 'mca14_13', 'mca', '13/2/1993', 'nilesh ashok kadam', 'nilesh.kadam', '123456', 'male', 'nilesh.kadam222@gmail.com', '9594197606', 'ghansoli ', 'navi mumbai', '25/7/15', '15/7/18', 'student', ''),
(5002, '', 'mca', '13/2/1993', 'nilesh kadam', 'nilesh123', '123456', 'male', 'nilesh.kadam222@gmail.com', '9594197606', 'ghansoli ', 'navi mumbai', '17/5/2007', '17/10/2011', 'teacher', 'images/user/nilesh.jpg'),
(5003, '', 'mca', '13/5/1995', 'abhi', 'abhi123', '1234', 'male', 'abhi@gmail.com', '9702970548', 'mumbai', 'mumbai', '25/5/2015', '25/5/2018', 'teacher', 'images/user/abhi.jpg');
