...
<head>
       <title></title>
<center><h3><b>FIRST CHOICE FILD BY STUDENT</b></h3></center></head>
<body>
<body bgcolor="#99CC33">
<link rel="stylesheet" href="st00.css">
<link rel="stylesheet" href="st4.css">
<form name="pp1" action="g01.php"  method="POST" >
...
<tr><td><p><b>COLLAGE NAME(1schoice)</b></p></td>
            <td><select name="gs2"><option> <?php echo $row['f1collage']; ?>
           </option></select> </td></tr>
            <tr><td><p><b>stream1</b></p></td>
            <td><input type="text" name="gs3" value="<?php echo $row['f1s1']; ?>">
            </td></tr>
            <tr><td><p><b>stream2</b></p></td>
            <td><input type="text" name="gs4" value="<?php echo $row['f1s2']; ?>">
