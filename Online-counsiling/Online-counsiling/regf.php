...
try{
    $dbh=new PDO("mysql:host=localhost;dbname=test","root","");
    //echo "Connection successful";
    $stm=$dbh->prepare("insert into student2 values('$name','$rollno','$rank','$gurdaintname','$address','$dob','$sex','$catagore','$age','$email','$cno','$state','$hs','$hsy','$f1collage','$f1s1','$f1s2','$f2collage','$f2s1','$f2s2','$f3collage','$f3s1','$f3s2','$password','$img')");
