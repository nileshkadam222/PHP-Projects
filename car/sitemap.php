...
<head>
<title>Site Map - Site Map | Speed Racing - Free Website Template from Templates.com</title>
		...
		<div class="row-1">
			...
			<div class="fright">
				<ul>
					...
					<li><a href="sitemap.php"><img src="images/icon3-act.gif" alt="" /></a></li>
				</ul>
			</div>
		</div>
		<div class="row-2">
			<div class="left">
				<ul>
					...
					<li class="last"><a href="sitemap.php" class="active"><span>site map</span></a></li>
				</ul>
			</div>
		</div>
		<div class="row-3">
...
<!-- FOOTER -->
	<div id="footer">
		...
		<div class="bottom">Copyright - @ CarRent@yahooo.com<br/>
			Speed Racing
		</div>
	</div>
</div>
