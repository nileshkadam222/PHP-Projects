...
namespace busbook
{
	...
	public class AdminResponse : System.Web.UI.Page
	{
		...
		{
			string strBname1="",strDate1="",strRtname="",strStatus="";
			string strBname2="";
			...
			{
			strDate1=e.Item.Cells[2].Text;
				strRtname=e.Item.Cells[3].Text;
				intXseats=Convert.ToInt16(e.Item.Cells[5].Text);
				strBname1=e.Item.Cells[6].Text;
				strStatus=e.Item.Cells[7].Text;
			...
			if(strStatus=="waiting")
			{
				...
				String comStr3="select bname,seatsallot from stafftable where bname!='"+strBname1+"' and dated='"+strDate1+"' and routename='"+strRtname+"' and seatsallot=(select max(seatsallot) from stafftable where bname!='"+strBname1+"' and dated='"+strDate1+"' and routename='"+strRtname+"')";
				...
				if(intStallot!=0)
				{
					...
					String comstr4="update stafftable set seatsallot="+intS1+" where bname='"+strBname2+"' and dated='"+strDate1+"' and routename='"+strRtname+"'";
					...
					String comStr5="select seatsallot from stafftable where bname='"+strBname1+"'";
					...
					String strComstr6="update stafftable set seatsallot="+intS1+" where bname='"+strBname1+"'and dated='"+strDate1+"' and routename='"+strRtname+"'";
					SqlCommand com6=new SqlCommand(strComstr6,con);
					if(com6.ExecuteNonQuery()>0)
					{
						String strComstr7="update extratkt set status='Granted' where brid='"+strBname1+"' and sdate='"+strDate1+"' and rname='"+strRtname+"'";
				...
				else
				{
						...
						String strComstr8="update extratkt set status='NoVacancy' where brid='"+strBname1+"' and sdate='"+strDate1+"' and rname='"+strRtname+"'";
