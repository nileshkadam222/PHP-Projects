...
{
$sql = mysql_query("SELECT * FROM doctor WHERE docid = '$_POST[loginid1]' AND password='$_POST[password]'");
$count =  mysql_num_rows($sql);
	if($count == 1)
	{
	$resrec= mysql_query("UPDATE doctor SET password='$_POST[newpass]' WHERE docid = '$_POST[loginid1]' ");
