...
$resrec= mysql_query("UPDATE admin SET adminname='$_POST[adminname]', contactno='$_POST[contactno]',emailid='$_POST[emailid]',password ='$_POST[password]'  WHERE adminid = '$_POST[adminid]' ");
