            ...
            <div class="bms_logo"> <img src="../images/bms_logo.png"></div>
                ...
                ?>     
                    ...
                    <div class="showimages">
                        <div id="bms_ename" style="margin: 5px 15px;">Sports</div>
                                 <ul id="push" class="profiles cf">
                                      <?php 
                                              include 'config.php';
                                            $query="select * from bms_sporttbl";
                                            $result=  mysql_query($query);  
			                    
                                             while($row =  mysql_fetch_array($result)){
                                                
                                                 $img=$row['img1'];
                                                $_SESSION["is"]=$row['sport_id'];
                                                 $mid= $_SESSION["is"];
                                                 $ename=$row['sport_name'];
                                     ...
                                     <?php  echo '   <li>
                                        <img class="pic" src="'.$img.'" alt="bookmyshow" />
                                         <ul class="info">
                                             <li><a href="sport_test.php?a='.$mid.' "title="">'.$ename.'</a></li>
                                              <br>
